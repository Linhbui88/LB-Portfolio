import ghfinder from './img/ghfinder.JPG'
...
export const projects = [
  {
    title: 'Github-finder',
    technologies: 'HTML, Tailwind CSS, Daisy UI, JavaScript, React',
    description:
      'A web application that helps finding Github users by name as well as displaying their Github’s stats.',
    img: ghfinder,
    code: 'https://github.com/Linhbui88/github-finder',
    deployedLink: 'https://linh-github-finder.herokuapp.com/',
  },
  {
    title: 'soulMatch',
