import tasksTracker from "./photo/tasksTracker.PNG";
import soulMatch from "./photo/soulMatch.PNG"
import netflixAndGrill from "./photo/netflixAndGrill.PNG"
import bookSearch from "./photo/book-search-engine.JPG"
import techBlog from "./photo/techBlog.PNG"
import yourLocalFarmer from "./photo/your-local-farmer.JPG"
 ...
 export const projects =[
  ...
  // },
  {
    ...
    description: "A dating web application utilizing MySQL + Sequelize in the back end when using Handlebars Templates to render HTML on the client side.",
    img :soulMatch,
  ...
  },
  {
    ...
    technologies: "JavaScript, Node, Express, Mongoose, MongoDB, GraphQL, React",
    description:"Full Stack MERN Application, using React to query and display books based on user searches, and allow the user to store them.",
    img :bookSearch,
